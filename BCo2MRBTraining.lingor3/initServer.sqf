...
cargoShip setVariable ["triggerName", t_cargoShip, true];
cargoShip setVariable ["spawnPoints", cargoShipTarget, true];
...
shootRangeLongLogic setVariable ["distancePosition", 400, true]; // current position of the targets
